...
<body data-spy="scroll" data-target=".onpage-navigation"
	...
	<div class="scroll-navigation">
		<div class="large-text align-center">
			<a class="section-scroll" href="#day1"><i
				class="fa fa-angle-down">day1</i></a>
		</div>
		<div class="large-text align-center">
			<a class="section-scroll" href="#day2"><i
				class="fa fa-angle-down">day2</i></a>
		</div>
		<div class="large-text align-center">
			<a class="section-scroll" href="#day3"><i
				class="fa fa-angle-down">day3</i></a>
		</div>
		<div class="large-text align-center">
			<a class="section-scroll" href="#day4"><i
				class="fa fa-angle-down">day4</i></a>
		</div>
		<div class="large-text align-center">
			<a class="section-scroll" href="#comments"><i
				class="fa fa-angle-down">댓글</i></a>
		</div>
	</div>
	<div class="main">
		...
		<section class="module-small" id="day1">
			<div class="container">
				<div class="row">
						...
						<div class="post">
							...
							<div class="post-entry">
								...
								<ul>
									...
									<li>For science, music, sport, etc, Europe uses the same
										vocabulary.</li>
								</ul>
								<p>The European languages are members of the same family.
									Their separate existence is a myth. For science, music, sport,
		...
		<section class="module-small" id="day2">
			<div class="container">
				<div class="row">
					<div class="col-sm-8 col-sm-offset-1">
						<div class="post">
		...
		<section class="module-small" id="day3">
			<div class="container">
				<div class="row">
					<div class="col-sm-8 col-sm-offset-1">
						<div class="post">
		...
		<section class="module-small" id="day4">
			<div class="container">
				<div class="row">
					<div class="col-sm-8 col-sm-offset-1">
						<div class="post">
		...
		<section class="module-small" id="comments">
			<div class="container">
				<div class="row">
					<div class="col-sm-8 col-sm-offset-1">
						<div class="comments">
