...
<body data-spy="scroll" data-target=".onpage-navigation"
	...
	<section class="home-section home-parallax home-fade home-full-height bg-dark-30" id="about" data-background="assets/images/03.jpg">
            <div class="col-xs-12 col-md-6 side-image" data-background="assets/images/03.jpg"></div>
					...
					<div class="col-sm-8 col-sm-offset-1">
						...
						<div class="post #">
							<div class="post-header font-alt">
								...
								<div class="post-meta">
									By&nbsp;<a href="#">| 23 November | 3 Comments | </a>Marketing,
									,Web Design<a href="#">A</a><a href="#"> </a><a href="#">w</a><a
										href="#">o</a><a href="#">n</a><a href="#">d</a><a href="#">e</a><a
										href="#">r</a><a href="#">f</a><a href="#">u</a><a href="#">l</a><a
										href="#"> </a><a href="#">s</a><a href="#">e</a><a href="#">r</a><a
										href="#">e</a><a href="#">n</a><a href="#">i</a><a href="#">t</a><a
										href="#">y</a><a href="#"> </a><a href="#">h</a><a href="#">a</a><a
										href="#">s</a><a href="#"> </a><a href="#">t</a><a href="#">a</a><a
										href="#">k</a><a href="#">e</a><a href="#">n</a><a href="#">
									</a><a href="#">p</a><a href="#">o</a><a href="#">s</a><a href="#">s</a><a
										href="#">e</a><a href="#">s</a><a href="#">s</a><a href="#">i</a><a
										href="#">o</a><a href="#">n</a><a href="#"> </a><a href="#">o</a><a
										href="#">f</a><a href="#"> </a><a href="#">m</a><a href="#">y</a><a
										href="#"> </a><a href="#">e</a><a href="#">n</a><a href="#">t</a><a
										href="#">i</a><a href="#">r</a><a href="#">e</a><a href="#">
									</a><a href="#">s</a><a href="#">o</a><a href="#">u</a><a href="#">l</a><a
										href="#">,</a><a href="#"> </a><a href="#">l</a><a href="#">i</a><a
										href="#">k</a><a href="#">e</a><a href="#"> </a><a href="#">t</a><a
										href="#">h</a><a href="#">e</a><a href="#">s</a><a href="#">e</a><a
										href="#"> </a><a href="#">s</a><a href="#">w</a><a href="#">e</a><a
										href="#">e</a><a href="#">t</a><a href="#"> </a><a href="#">m</a><a
										href="#">o</a><a href="#">r</a><a href="#">n</a><a href="#">i</a><a
										href="#">n</a><a href="#">g</a><a href="#">s</a><a href="#">
									</a><a href="#">o</a><a href="#">f</a><a href="#"> </a><a href="#">s</a><a
										href="#">p</a><a href="#">r</a><a href="#">i</a><a href="#">n</a><a
										href="#">g</a><a href="#"> </a><a href="#">w</a><a href="#">h</a><a
										href="#">i</a><a href="#">c</a><a href="#">h</a><a href="#">
									</a><a href="#">I</a><a href="#"> </a><a href="#">e</a><a href="#">n</a><a
										href="#">j</a><a href="#">o</a><a href="#">y</a><a href="#">
									</a><a href="#">w</a><a href="#">i</a><a href="#">t</a><a href="#">h</a><a
										href="#"> </a><a href="#">m</a><a href="#">y</a><a href="#">
									</a><a href="#">w</a><a href="#">h</a><a href="#">o</a><a href="#">l</a><a
										href="#">e</a><a href="#"> </a><a href="#">h</a><a href="#">e</a><a
										href="#">a</a><a href="#">r</a><a href="#">t</a><a href="#">.</a><a
										href="#"> </a><a href="#">I</a><a href="#"> </a><a href="#">a</a><a
										href="#">m</a><a href="#"> </a><a href="#">a</a><a href="#">l</a><a
										href="#">o</a><a href="#">n</a><a href="#">e</a><a href="#">,</a><a
										href="#"> </a><a href="#">a</a><a href="#">n</a><a href="#">d</a><a
										href="#"> </a><a href="#">f</a><a href="#">e</a><a href="#">e</a><a
										href="#">l</a><a href="#"> </a><a href="#">t</a><a href="#">h</a><a
										href="#">e</a><a href="#"> </a><a href="#">c</a><a href="#">h</a><a
										href="#">a</a><a href="#">r</a><a href="#">m</a><a href="#">
									</a><a href="#">o</a><a href="#">f</a><a href="#"> </a><a href="#">e</a><a
										href="#">x</a><a href="#">i</a><a href="#">s</a><a href="#">t</a><a
										href="#">e</a><a href="#">n</a><a href="#">c</a><a href="#">e</a><a
										href="#"> </a><a href="#">i</a><a href="#">n</a><a href="#">
									</a><a href="#">t</a><a href="#">h</a><a href="#">i</a><a href="#">s</a><a
										href="#"> </a><a href="#">s</a><a href="#">p</a><a href="#">o</a><a
										href="#">t</a><a href="#">,</a><a href="#"> </a><a href="#">w</a><a
										href="#">h</a><a href="#">i</a><a href="#">c</a><a href="#">h</a><a
										href="#"> </a><a href="#">w</a><a href="#">a</a><a href="#">s</a><a
										href="#"> </a><a href="#">c</a><a href="#">r</a><a href="#">e</a><a
										href="#">a</a><a href="#">t</a><a href="#">e</a><a href="#">d</a><a
										href="#"> </a><a href="#">f</a><a href="#">o</a><a href="#">r</a><a
										href="#"> </a><a href="#">t</a><a href="#">h</a><a href="#">e</a><a
										href="#"> </a><a href="#">b</a><a href="#">l</a><a href="#">i</a><a
										href="#">s</a><a href="#">s</a><a href="#"> </a><a href="#">o</a><a
										href="#">f</a><a href="#"> </a><a href="#">s</a><a href="#">o</a><a
										href="#">u</a><a href="#">l</a><a href="#">s</a><a href="#">
									</a><a href="#">l</a><a href="#">i</a><a href="#">k</a><a href="#">e</a><a
										href="#"> </a><a href="#">m</a><a href="#">i</a><a href="#">n</a><a
										href="#">e</a><a href="#">.</a>
								</div>
							</div>
							<div class="post-entry">
							...
							<div class="post-more">
								<a class="more-link" href="Post with text only">Read more</a>
							</div>
						</div>
						<div class="post">
						...
						<div class="post">
							<div class="post-images-slider">
								<ul class="slides">
									<li><img src="assets/images/post-1.jpg"
										alt="Blog Slider Image" /></li>
									<li><img src="assets/images/post-3.jpg"
										alt="Blog Slider Image" /></li>
								</ul>
							</div>
							<div class="post-header font-alt">
								<h2 class="post-title">
									<a href="#">Post with slideshow</a>
								</h2>
								<div class="post-meta">
									By&nbsp;<a href="#">Mark Stone</a>| 23 November | 3 Comments |
									<a href="#">Marketing, </a><a href="#">Web Design</a>
